...
import net.sharetrip.b2b.databinding.FragmentSingleCalendarBinding
import net.sharetrip.b2b.util.AppSharedPreference
import net.sharetrip.b2b.util.DateUtil
import net.sharetrip.b2b.util.getProperFlightStartDate
...
import net.sharetrip.b2b.view.flight.history.reissue_change_date.models.Fare
import net.sharetrip.b2b.view.flight.history.reissue_change_date.models.ServiceType
...
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.PrefKey
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.Strings
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.convertToK
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.daysOfWeekFromLocale
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.makeInVisible
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.makeVisible
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.replaceFirstChar
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.setTextColorRes
import net.sharetrip.b2b.view.flight.history.reissue_change_date.utils.titlecase
...
class SingleDateCalendarFragment: Fragment() {

    companion object {
        const val TAG = "SingleDateCalendar"
        const val EXTRA_DATE_IN_MILLISECOND =
            "BaseCalenderSingleDateSelectFragment.StartDateInMillisecond"
    }

    private var _bindingView: FragmentSingleCalendarBinding? = null
    private val bindingView: FragmentSingleCalendarBinding get() = _bindingView!!
    ...
    override fun onCreateView(
        ...
        this._bindingView = FragmentSingleCalendarBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        today =
            LocalDate.now().plusDays(
                AppSharedPreference[PrefKey.FLIGHT_SEARCH_THRESHOLD_TIME, "20:00"]
                    .getProperFlightStartDate(
                        AppSharedPreference[PrefKey.BOOK_TODAY_FLIGHT, false]
                )
            )
        ...
        bindingView.exFourCalendar.monthHeaderBinder =
            object : MonthHeaderFooterBinder<MonthViewContainer> {
                ...
                override fun bind(container: MonthViewContainer, month: CalendarMonth) {
                    val monthTitle =
                        "${
                            month.yearMonth.month.name.toLowerCase(Locale.ROOT)
