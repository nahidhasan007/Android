package net.sharetrip.b2b.imageCoprresion
...
object Compressor {
    ...
    fun compressImageFile(imageFile: File?, reqHeight: Int, reqWidth: Int,
                          filePath: String?, quality: Int,
                          compressFormat: CompressFormat?, orientation: Int): File {
